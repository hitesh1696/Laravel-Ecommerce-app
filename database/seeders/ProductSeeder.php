    ...
    public function run()
    {
        ...
        for ($i=1; $i <= 30; $i++) {
            Product::create([
                ...
                'image' => 'products/September2021/laptop-'.$i.'.jpg',
        ...
        for ($i = 1; $i <= 9; $i++) {
            Product::create([
                ...
                'description' => 'Lorem ' . $i . ' ipsum dolor sit amet, consectetur adipisicing elit. Ipsum temporibus iusto ipsa, asperiores voluptas unde aspernatur praesentium in? Aliquam, dolore!',
                'image' => 'products/September2021/desktop-'.$i.'.jpg',
            ])->categories()->attach(2);
        }
        ...
        for ($i = 1; $i <= 9; $i++) {
            Product::create([
                ...
                'description' => 'Lorem ' . $i . ' ipsum dolor sit amet, consectetur adipisicing elit. Ipsum temporibus iusto ipsa, asperiores voluptas unde aspernatur praesentium in? Aliquam, dolore!',
                'image' => 'products/September2021/phone-'.$i.'.jpg',
        ...
        for ($i = 1; $i <= 9; $i++) {
            Product::create([
                ...
                'description' => 'Lorem ' . $i . ' ipsum dolor sit amet, consectetur adipisicing elit. Ipsum temporibus iusto ipsa, asperiores voluptas unde aspernatur praesentium in? Aliquam, dolore!',
                'image' => 'products/September2021/tablet-'.$i.'.jpg',
        ...
        for ($i = 1; $i <= 9; $i++) {
            Product::create([
                ...
                'price' => rand(79999, 149999),
                'description' => 'Lorem ' . $i . ' ipsum dolor sit amet, consectetur adipisicing elit. Ipsum temporibus iusto ipsa, asperiores voluptas unde aspernatur praesentium in? Aliquam, dolore!',
                'image' => 'products/September2021/tv-'.$i.'.jpg',
        ...
        for ($i = 1; $i <= 9; $i++) {
            Product::create([
                ...
                'description' => 'Lorem ' . $i . ' ipsum dolor sit amet, consectetur adipisicing elit. Ipsum temporibus iusto ipsa, asperiores voluptas unde aspernatur praesentium in? Aliquam, dolore!',
                'image' => 'products/September2021/camera-'.$i.'.jpg',
        ...
        for ($i = 1; $i <= 9; $i++) {
            Product::create([
                ...
                'price' => rand(79999, 149999),
                'description' => 'Lorem ' . $i . ' ipsum dolor sit amet, consectetur adipisicing elit. Ipsum temporibus iusto ipsa, asperiores voluptas unde aspernatur praesentium in? Aliquam, dolore!',
                'image' => 'products/September2021/appliance-'.$i.'.jpg',
